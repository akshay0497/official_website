            ...
            <div className="container mx-auto">
                ...
                <div className="gap-8">
                    {remData?.map((item: any) => (
                        <div key={item.Id}
                            className="bg-white p-6 rounded-bl-[30px] rounded-tr-[30px] hover:rounded-tl-[30px] hover:rounded-bl-none hover:rounded-tr-none hover:rounded-br-[30px] shadow-md hover:shadow-lg shadow-purple-400 hover:shadow-purple-400 transition-shadow duration-300 transform hover:scale-104 m-2"
                        >
